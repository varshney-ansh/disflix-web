...
const DetailComponent = async ({ movie, movies }) => {
    ...
    return (
        <div style={{ background: 'rgb(0,5,13)' }}>
            <Navbar />
            <div className={styles.container}>
                <div className={styles.contents}>
                    <div className={styles.contentImg}>
                        <div className={styles.backgroundImage}>
                            <Image src={movie.bgImg} alt="disflix-movie-bg" loading="eager" fill style={{ aspectRatio: 16 / 9 }} sizes={`(max-width: 28em) 450px, (max-width: 55em) 900px, (max-width: 80em) 1300px, (max-width: 100em) 1600px, (max-width: 150em) 2400px, 1920px`} />
                    ...
                    <div className={styles.content}>
                        ...
                        <div className={styles.buttons}>
                            <div className={styles.btnContainer}>
                                <div>
                                    <Link href={`/watch/movie/${movie.titleId}`} className={styles.play}>
