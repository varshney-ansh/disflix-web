...
const AnimeWatchPage = async({params}) =>{
    ...
    return(
        <div><WatchComponent ads={ads} url={`https://ftp.itec.aau.at/datasets/DASHDataset2014/ElephantsDream/15sec/ElephantsDream_15s_onDemand_2014_05_09.mpd`} img={getAnime.episodes[episodeNo].posterImg} /></div>
    )
}
